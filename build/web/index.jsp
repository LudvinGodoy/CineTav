        ...
        <div id="headertext">
          <div class="container">
            <div class="headertitle">
              <h1 class="pagetitle">Bienvenido a Cinema TAV</h1>
        ...
        <div id="slidercontainer">
          <section id="slider">
            <div id="slideritems" class="flexslider">
              <ul class="slides">
                  <li><img src="images/prin.jpg" alt="">
                ...
                <li><img src="images/rp.JPG" alt="">
                  <div class="flex-caption">
                    <div class="slidertext">
                      <h1>Vealo solo en cines</h1>
                    </div>
                  </div>
                </li>
                <li><img src="images/rp2.jpg" alt="">
                  <div class="flex-caption">
                    <div class="slidertext">
                      <h1>Estreno </h1>
                    </div>
                  ...
                  <div class="widget-bottom">
                    <ul>
                      <li id="ts-recent-posts-2" class="widget-container widget_ts_recent_posts">
                        <h2 class="widget-title"><span> Sistema de cine TAV</span></h2>
                  ...
                  <div class="widget-bottom">
                    <ul>
                      <li id="text-2" class="widget-container widget_text">
                        <h2 class="widget-title"><span>Ludvin Godoy</span></h2>
                        <div class="textwidget">
                          <ul class="sn">
                            ...
                            <li><a target="_blank" href="http://pinterest.com"><span class="icon-img" style="background-image:url(images/pinterest.png)"></span></a></li>
                          </ul>
                        </div>
                      </li>
                    </ul>
